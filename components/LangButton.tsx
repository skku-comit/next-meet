...
const LangButton = ({ lang, setLang }: LangButtonProps): ReactNode => {
  ...
  return (
    <div className={`w-20 h-10 rounded-full relative ${lang !="ko"? "bg-white border-red-300":"bg-red-300"} mt-4`} style={{borderWidth:lang !="ko"? "3.5px" : "", width:"80px", height:"40px"}}>
      <div
      ...
      {lang == "ko" ? 
          <p className="text-white absolute" style={{right:"12px", paddingTop:"6.7px", fontSize:"21px"}}>영</p>
