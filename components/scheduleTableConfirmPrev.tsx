...
const ScheduleTableConfirmPrev = React.memo(function ScheduleTableConfirm({fixedDate, fixedDay, fixedTime, isLogin, width, week, fixedSchedule, setFixedSchedule, scheduleTable, setScheduleTable}:MyComponentProps) {
  // console.log(isLogin)
...
export default React.memo(ScheduleTableConfirmPrev);
